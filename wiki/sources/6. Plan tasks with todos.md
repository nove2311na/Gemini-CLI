...
url: "https://geminicli.com/docs/cli/tutorials/task-planning/"
venue: "Gemini CLI Documentation"
authors: []
year: 2026
description: "Tutorial on using Gemini CLI's built-in task planning and todo list for complex workflows."
---

# Plan tasks with todos

Keep complex jobs on the rails with Gemini CLI's built-in task planning. This tutorial covers how to ask for a plan, execute it step-by-step, and monitor progress with the todo list.
...
Gemini will analyze your codebase and use the [[write-todos-tool]] to generate a structured list.
...
- Explore [[session-management]] to save your plan and finish it tomorrow.
- See the [[write-todos-tool]] reference for technical schema details.