...
To see what’s possible, browse the [Gemini CLI extension gallery](https://geminicli.com/extensions/browse/).
...
- **[Manage extensions](#manage-extensions):** List and verify your installed extensions.
- **[Install extensions](#installation):** Add new capabilities from GitHub or local paths.

### I want to build extensions

Learn how to create, test, and share your own extensions with the community.

- **[Build extensions](https://geminicli.com/docs/extensions/writing-extensions):** Create your first extension from a template.
- **[Best practices](https://geminicli.com/docs/extensions/best-practices):** Learn how to build secure and reliable extensions.
- **[Publish to the gallery](https://geminicli.com/docs/extensions/releasing):** Share your work with the world.
...
For more advanced installation options, see the [Extension reference](https://geminicli.com/docs/extensions/reference#install-an-extension).